...
FemaleWeights = ['WomenStrawweight', 'WomenBantamweight', 'WomenFlyweight', 'WomenFeatherweight']
...
#        PPVsales.append(meanPPV)
    ...
    for fight in range(0, len(window_data)):
        if window_data['weight_class'][fight] in FemaleWeights:
...
#    components = len(list(nx.connected_components(fights)))
#    print(components)
