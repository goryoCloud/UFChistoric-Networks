...
#%%
pathDataframes = 'C:/Users/max_s/Desktop/MAGISTER-MAX/NOTES/UFC/UFCDATA/dataframes3/eigenEvol.csv'
...
for fighter in fighterNames['fighter']:
    ...
    try:
        ...
        pearson = pearsonCoeff(merged_data[f'{fighter}_x'], merged_data[f'{fighter}_y'])[0]
...
#%%
import csv
output_csv_path = 'C:/Users/max_s/Desktop/MAGISTER-MAX/NOTES/UFC/UFCDATA/timeseriesCorrelations/eigenEvolCorrelationTest.csv'
