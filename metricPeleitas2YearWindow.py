...
#plt.show()
#%%
savingPath = 'C:/Users/max_s/Desktop/MAGISTER-MAX/NOTES/UFC/paperImages/networkFightsPPV/'
#%%
plt.rc('xtick', labelsize='x-large')
...
PPVnonZero = PPVsales[67:286]
#-----------------------------------------------------
clustPPV =  clust[67:286]
