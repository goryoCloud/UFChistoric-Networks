...
savingPath = 'C:/Users/max_s/Desktop/MAGISTER-MAX/NOTES/UFC/paperImages/0networkFightsPPV/EPSfigs/'
#%%

fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(clust, color='red', lw  = 2.5, label=r'$\langle C  \rangle$')
...
plt.tight_layout()
plt.savefig(f'{savingPath}clustering.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(deg, color='blue', lw  = 2.5, label=r'$\langle C  \rangle$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$\langle k  \rangle$')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}degree.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(den, color='green', lw  = 2.5, label=r'$D$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$D$')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}normDegree.eps', dpi = 5000)
plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(gin, color='m', lw  = 2.5, label=r'$\langle C  \rangle$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$ G[p(k)] $')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}gini.eps', dpi = 5000)
plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(numFights, color='orange', lw  = 2.5, label=r'$\langle C  \rangle$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$N_{fights}$')
...
plt.xlim(0, len(clust))
plt.tight_layout()
plt.savefig(f'{savingPath}nFights.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(numFighters, color='olive', lw  = 2.5, label=r'$\langle C  \rangle$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$N_{fighters}$')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}nFighters.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(pathLenght, color='teal', lw  = 2.5, label=r'$\langle C  \rangle$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$l$')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}path.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(betweeness, color='darkblue', lw  = 2.5, label=r'$b$')
ax1.set_xlabel('window index')
ax1.set_ylabel(r'$b$')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}betweeness.eps', dpi = 5000)

plt.show()
#%%
fig, ax1 = plt.subplots(figsize = (6,4))
ax1.plot(eigenvector, color='darkgreen', lw  = 2.5, label=r'$b$')
ax1.set_xlabel('window index')
...
#ax2.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
plt.tight_layout()
plt.savefig(f'{savingPath}eigen.eps', dpi = 5000)
plt.show()
#%%
